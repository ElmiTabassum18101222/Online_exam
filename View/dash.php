      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="dash.php?q=5">Add Result</a></li>
...
$result = mysqli_query($con,"SELECT * FROM course WHERE email='$email' ORDER BY course_code ASC") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Course Code</b></td><td><b>Course Title</b></td><td><b>Quiz Ans</b></td><td><b>Mid Term Ans</b></td><td><b>Final Ans</b></td></tr>';
$c=1;
...
//if($row == 0){
	echo '<tr><td>'.$c++.'</td><td>'.$course_code.'</td><td>'.$title.'</td><td><a href="download.php?FilePaths='.$a_quiz.'">Answer</a></td><td><a href="download.php?FilePaths='.$a_mid.'">Answer</a></td><td><a href="download.php?FilePaths='.$a_final.'">Answer</a></td></tr>';
//}
//else
//{
...
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$department.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
...
while($row = mysqli_fetch_array($result)) {
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$department.'</td><td>'.$email.'</td>
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Examination Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST" enctype="multipart/form-data">
<fieldset>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="deadline"></label>  
  <div class="col-md-12">
  <input id="deadline" name="deadline" placeholder="Enter deadline(DD-MM-YYYY)" class="form-control input-md" type="date">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="qfile"></label>  
  <div class="col-md-12">
  <input id="qfile" name="qfile" placeholder="Select a pdf file" class="form-control input-md" type="file">
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Upload Answer</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update.php?q=addresult"  method="POST" enctype="multipart/form-data">
<fieldset>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="rfile"></label>  
  <div class="col-md-12">
  <input id="rfile" name="rfile" placeholder="Select a pdf file" class="form-control input-md" type="file">
